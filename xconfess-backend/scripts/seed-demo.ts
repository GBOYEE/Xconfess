...
const REACTION_EMOJIS = ['heart', 'laugh', 'fire', 'eyes', '100', 'raised-hands', 'cry', 'thinking'];
...
const SAMPLE_COMMENTS = [
  ...
  'Journaling speedrun any percent',
...
async function main() {
  ...
  try {
    ...
    const allTagNames = [...new Set(DEMO_CONFESSIONS.flatMap(function(c) { return c.tags; }))];
    const tagMap = {};
